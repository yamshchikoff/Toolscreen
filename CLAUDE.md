...
- **Запрещено просить пользователя вернуться в игру с активными брикпойнтами.** Это правило абсолютное. Не подлежит нарушению никогда, ни при каких обстоятельствах, не оправдывается ничем. Брикпойнт заморозит игру, пользователь залипнет.
