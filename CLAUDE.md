...
- **После каждого патча — безусловный коммит и пуш.** Как только изменения готовы и проверены, сразу `git add -A && git commit && git push`. Без ожидания дополнительных подтверждений.
